...
{{-- Note: Deactivating a user is like HIDING/DELETING the user in the application, but
    the data will remain intact in the database
    For this -- we have apply --> SoftDeletes
--}}