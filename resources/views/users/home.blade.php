...
@section('content')
    <div class="row gx-5">
        <div class="col-8">
            ...
            @empty
                {{-- If the site doesn't have post, we will display a link for them to create a post --}}
        ...
        <div class="col-4 bg-light">
            {{-- Profile Overview --}}
            <div class="row align-items-center mb-5 bg-light shadow-sm rounded-3 py-3">
                <div class="col-auto">
                ...
                <div class="row align-items-center mb-3">
                    ...
                    <div class="col-auto">
                        <form action="{{ route('follow.store', $user->id) }}" method="post">
                            @csrf
                            <button type="submit" class="border-0 bg-primary p-1 rounded text-white btn-sm">Follow</button>
                        </form>
                    </div>
                </div>
            @endforeach
