        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
                    {{-- [SOON] Search Bar here. Show a search bar when the user is login --}}
        ...
        <main class="py-5">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    {{-- HTTP Request --}}
                    {{-- http://localhost/post/4/show       ---> regular routes (not an admin) --}}
                    {{-- http://localhost/admin/users       ---> admin route --}}
                    {{-- http://localhost/admin             ---> regular routes ( not an admin)--}}
                    {{-- http://localhost/admin/5/update    ---> admin route --}}

                    {{-- Web.php --}}
                    {{-- prefix: admin/users, admin/posts, admin/categories --}}
